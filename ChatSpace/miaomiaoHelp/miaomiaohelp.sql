...
--
-- Table structure for table `predefined_addresses`
--

DROP TABLE IF EXISTS `predefined_addresses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `predefined_addresses` (
...
--
-- Dumping data for table `predefined_addresses`
--

LOCK TABLES `predefined_addresses` WRITE;
/*!40000 ALTER TABLE `predefined_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `predefined_addresses` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_addresses` (
  ...
  CONSTRAINT `user_addresses_ibfk_2` FOREIGN KEY (`address_id`) REFERENCES `predefined_addresses` (`address_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-16  9:27:38
